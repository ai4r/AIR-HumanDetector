...
class convolutional_layer(Layer):
    ...
    def setup(self, ksize, c, n, stride, pad, batch_norm, activation, is_parallel, option):
        self.batch_norm = bool(batch_norm)
        self.activation = activation
        self.stride = stride
        self.ksize = ksize
        ...
        self.is_parallel = (is_parallel == 1)
    ...
    def __eq__(self, other):
        # Ignore last 2 parameters - is_parallel and option
        # return self.signature[:-2] == other.signature[:-2]

        # Ignore index, is_parallel and option
        is_conv = self.signature[0] == other.signature[0]
        same_size = self.signature[2:-2] == other.signature[2:-2]
        return is_conv and same_size